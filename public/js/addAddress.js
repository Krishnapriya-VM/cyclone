...
async function addAddress(fdata, ldata, mdata, hdata, sdata, landdata, tdata, ddata, cdata, statedata, pdata){
        try {
            console.log(fdata, ldata, mdata, hdata, sdata, landdata, tdata, ddata, cdata, statedata, pdata);
            const formdata = {
                fdata,
                ldata,
                mdata,
            ...
            const res = await fetch('/address/add-address', {
                method: 'POST',
                headers: {
  ...
  addAddressform.addEventListener('submit', (event) =>{
    ...
    if(error1.innerHTML === "" || error2.innerHTML === "" ||
        ...
        error11.innerHTML === "")
        {
        addAddress(fdata, ldata, mdata, hdata, sdata, landdata, tdata, ddata, cdata, statedata, pdata)   
    }
  })
